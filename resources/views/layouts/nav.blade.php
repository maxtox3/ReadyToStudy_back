        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-4 py-4">
                    <h4 class="text-white">Разделы</h4>
                    <ul class="list-unstyled">
                        <li><a href="{{ url('analytics') }}" class="nav-link ml-auto">Аналитика</a></li>
                        {{--<ul class="nav nav-pills float-right">--}}

                            @if(session()->get('user') != null)
                                <li>
                                    <a class="nav-link ml-auto" href="{{ url('profile') }}">{{ session()->get('user')->name }}</a>
                                </li>
