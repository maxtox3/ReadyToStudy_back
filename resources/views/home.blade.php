...
@section('content')
    ...
    {{--<h1 class="display-4">--}}
    {{--Добро пожаловать на сайт<br>Ready to Study</h1>--}}
    {{--@if(session()->get('user')->is_teacher)--}}
    {{--<p class="lead text-muted">Будучи преподавателем, Вы можете создать новую дисциплину, тему, тест. Также вы можете просто импортировать</p>--}}
    {{--@endif--}}
    {{--@endif--}}
    {{--</div>--}}
    {{--@if(session()->get('user') != null)--}}
    ...
    {{--<a href="{{ url('createDiscipline') }}" class="btn btn-primary btn-block">Создать</a>--}}
    {{--</div>--}}
    {{--</div>--}}
    {{--</div>--}}
    {{--<div class="col-sm-4">--}}
    ...
    {{--<a href="{{ url('createTheme') }}" class="btn btn-primary btn-block">Создать</a>--}}
    {{--</div>--}}
    {{--</div>--}}
    {{--</div>--}}
    {{--<div class="col-sm-4">--}}
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-9 mx-auto">
                    <h1 class="mb-3">Подготовиться к экзаменам? Проще простого!</h1>
                </div>
                <div class="col-md-10 col-lg-8 col-xl-7 mx-auto">
                    <div class="row">
                        <button type="submit" class="btn btn-block btn-lg btn-primary center">Войти</button>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="features-icons-item mx-auto mb-5 mb-lg-0 mb-lg-3">
                        ...
                        <h3>Мобильность</h3>
                        <p class="lead mb-0">Все тесты доступны в мобильном приложении!</p>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="features-icons-item mx-auto mb-5 mb-lg-0 mb-lg-3">
